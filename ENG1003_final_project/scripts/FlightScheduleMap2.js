...
// function to create popups on mapbox
...
function countryAirportMatch()
{
  ...
  else
  {
      ...
      let q1 = new ArrivalAirport(countryValue,airportValue,arrivallat,arrivallong)
      localStorage.setItem("arr1strg",JSON.stringify(q1))
      flightLocal.arrivalAirport = q1;
      ...
      window.location.href = "(4)ArrivalDetails.html";
  }
}
// same as flight schedule map 1
